...
```{r standardisation}
train_data$annual_inc2 <- scale(train_data$annual_inc)
train_data$loan_amnt2 <- scale(train_data$loan_amnt)
train_data$revol_bal2 <- scale(train_data$revol_bal)
#train_data$credit_age_yrs <- scale(train_data$credit_age_yrs)
