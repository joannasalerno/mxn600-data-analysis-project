...
nlevels(extended$location) # added location, which is in the form of state:zip
...
* We might want to explore other variables and interactions between variables that may help to predict loan default
