...
Now, we can assess the performance benchmarks of the chosen extended model and compare these to the final model we obtained in the first part of this analysis. We begin by creating a ROC curve and computing a Gini score for the extended model.
