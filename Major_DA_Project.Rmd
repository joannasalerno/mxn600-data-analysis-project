...
We conducted an exploratory data analysis of our dataset, focusing on the numeric variables of interest. The above plots shows the distribution of these variables. This analysis revealed that several variables, namely 'annual_inc,' 'delinq_2yrs,' 'inq_last_6mths,' 'pub_rec,' and 'revol_bal,' exhibited significant outliers, which can potentially impact the integrity of our analysis.

To address the presence of these outliers and to ensure the robustness of our subsequent statistical modeling, we have chosen to apply a scaling transformation to the numeric covariates in the dataset. The resulting scaled covariates will enable us to conduct our analysis with a dataset that has been preprocessed to reduce the undue impact of outliers.
...
For loans with a stated purpose of debt_consolidation, the odds of "repay_fail" occurring increase by a factor of approximately 1.24 (95% CI: [1.04-1.48], $p = 0.016010$), compared to the baseline.
...
For loans with a stated purpose of renewable_energy, the odds of "repay_fail" occurring increase by a factor of approximately 1.82% (95% CI: [1.00-3.28], $p = 0.0470893$), compared to the baseline.
