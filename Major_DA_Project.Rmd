...
The cloglog model has a slightly lower Gini score on the the training dataset (Logit model: $Gini=0.410$ on train, $Gini=0.395$ on validation vs. Cloglog model: $Gini=0.407$ on train, $Gini=0.395$ on validation).
