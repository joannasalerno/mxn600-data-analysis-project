...
parameter_estimates <- summary_fit5$coef[, "Estimate"]
standard_errors <- summary_fit5$coef[, "Std. Error"]
p_values <- summary_fit5$coef[, "Pr(>|z|)"]
...
knitr::kable(
  model_results %>% filter(p_value < 0.05),
  col.names = c("Estimate", "Odds Ratio", "Lower Bound (2.5%)", "Upper Bound (97.5%)", "p-value")
)
```
