...
prob=predict(fit_logit,newdata=test_scaled_data,type=c("response"))
g <- roc(test_scaled_data$repay_fail ~ prob)
AUC <- g$auc
AUC
Gini <- 2*(AUC - 1/2)
Gini
...
- For a one-unit increase in the interest rate, the odds of "repay_fail" occurring increase by a factor of approximately 1.57. This is a significant effect with a very low p-value.
...
For individuals with missing or not specified employment length, or unemployed individual ("n/a"), For a one-unit increase in the emp_lengthn/a, the odds of "repay_fail" occurring increase by a factor of approximately 1.73. This effect is statistically significant with a very low p-value, indicating that the absence of employment length information or for unemployed individual is associated with a higher likelihood of loan repayment failure.

- For a one-unit increase in annual income, the odds of "repay_fail" occurring decrease by a factor of approximately 0.71. This is a significant effect with a very low p-value.
...
For a one-unit increase in medical purpose, the odds of "repay_fail" occurring increase by a factor of approximately 1.83.
For a one-unit increase in moving purpose, the odds of "repay_fail" occurring increase by a factor of approximately 1.65.
For a one-unit increase in other purpose, the odds of "repay_fail" occurring increase by a factor of approximately 1.58.
For a one-unit increase in small business purpose, the odds of "repay_fail" occurring increase by a factor of approximately 2.78.  This effect is statistically significant with a very low p-value, indicating that the small business loan purpose is associated with a higher likelihood of loan repayment failure.
For a one-unit increase in vacation purpose, the odds of "repay_fail" occurring increase by a factor of approximately 1.56. 
...
- For a one-unit increase in the number of inquiries in past 6 months, the odds of "repay_fail" occurring increase by a factor of approximately 1.24. This is a significant effect with a very low p-value.

- For a one-unit increase in the number of derogatory public records, the odds of "repay_fail" occurring increase by a factor of approximately 1.06. 

- For a one-unit increase in revolving balance, the odds of "repay_fail" occurring increase by a factor of approximately 1.10.

- For a one-unit increase in revolving utilization, the odds of "repay_fail" occurring increase by a factor of approximately 1.12.

- Having a 60-month loan term increases the odds of "repay_fail" occurring by a factor of approximately 1.67 compared to the reference category (36 months loan term).
