...
- For a one-unit increase in the interest rate, the odds of "repay_fail" occurring increase by a factor of approximately 1.57 (95% CI: [1.48,1.67], $p < 2e-16$).
...
As mentioned above, the specific loan purposes of "medical," "moving," "other," and "small_business" are all associated with a higher likelihood of loan repayment failure, as each had a statsitically significant effect with a $p < 0.05$.
 
- For a one-unit increase in the number of inquiries in past 6 months, the odds of "repay_fail" occurring increase by a factor of approximately 1.24 (95% CI: [1.20,1.28], $p < 2e-16$).
...
*** MIGHT NOT KEEP THIS? AS IT IS PREDICTION...
