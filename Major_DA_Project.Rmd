...
ggplot(plot_data, aes(x = OddsRatio, xmin = LowerCI, xmax = UpperCI, y = Variable)) +
  ...
  ggtitle("Odds Ratios of Rapyment Failure")
```
...
# Calculate the odds ratios by exponentiating the parameter estimate values
odds_ratios2 <- exp(parameter_estimates)

# Calculate the confidence intervals for the odds ratios
lower_ci2 <- exp(parameter_estimates - 1.96 * standard_errors)  # 1.96 corresponds to a 95% confidence interval
upper_ci2 <- exp(parameter_estimates + 1.96 * standard_errors)
...
For a one-unit increase in the purpose of debt_consolidation, the odds of "repay_fail" occurring increase by a factor of approximately 1.24% (95% CI: 0.99-1.55). This effect is statistically significant with a very low p-value, indicating that loan taken out for the purpose of debt consolidation is associated with a higher likelihood of loan repayment failure.

* purpose == educational

For a one-unit increase in the purpose educational, the odds of "repay_fail" occurring increase by a factor of approximately 1.29% (95% CI: 1.29-0.83). This effect is statistically significant with a very low p-value.

* purpose == home_improvement

For a one-unit increase in the purpose home_improvement, the odds of "repay_fail" occurring increase by a factor of approximately 1.19% (95% CI: 0.92-1.54).

* purpose == renewable_energy

For a one-unit increase in the purpose renewable_energy, the odds of "repay_fail" occurring increase by a factor of approximately 1.48% (95% CI: 0.66-3.29).
